...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    connect: {
      ...
      public: {
        options: {
          ...
          livereload: false,
          hostname: '<%= _.slugify(appname) %>.lcl'
        }
      }
    },
      ...
      public: {
        files: [{
          ...
          src: [
            ...
            '<%%= yeoman.public %>/javascripts/*',
            '<%%= yeoman.public %>/styles/*',
          ]
        }]
      },
      server: '<%%= yeoman.app %>'
    ...
    bowerInstall: {
      app: {
        ...
        exclude: ['<%%= yeoman.app %>/bower_components/bootstrap-sass-official/vendor/assets/javascripts/bootstrap.js']
      },
      sass: {
  ...
  grunt.registerTask('serve-public', function(target) {
    if (target === 'public') {
      return grunt.task.run(['build', 'connect:public:keepalive']);
    }
  ...
  grunt.registerTask('build-public', [
    ...
    'cssmin',
    'uglify',
    'copy:public',<% if (includeModernizr) { %>
    'modernizr',<% } %>
    'usemin'
  ]);
